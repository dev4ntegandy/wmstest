    ...
    <>
      ...
      <Card>
        <CardHeader className="border-b border-slate-200 px-6 py-4">
          <CardTitle className="text-lg font-medium">Business Intelligence</CardTitle>
        </CardHeader>
        <CardContent className="p-6">
          <div className="text-center py-12">
            ...
            <p className="text-slate-500 mb-6">Check back soon for reports and analytics functionality.</p>
